...
class Campaign
{
    ...
    function __construct($source, $medium, $campaign, $term = NULL, $content = NULL)
    {
        ...
        if (empty($source)) {
            throw new InvalidStateException("GA: UTM parameter source is not filled correctly!");
        }
        if (empty($medium)) {
            throw new InvalidStateException("GA: UTM parameter medium is not filled correctly!");
        }
        if (empty($campaign)) {
            throw new InvalidStateException("GA: UTM parameter campaign is not filled correctly!");
        }
