...
namespace Tlapnet\Forge\Config;
...
class Node
{
	...
	public function validate($value): void
	{
		...
		if ($value === self::NOT_AVAILABLE && $this->defaultValue !== null) {
			return;
		}
	...
	public function merge($value)
	{
		...
		if ($value === self::NOT_AVAILABLE
			&& $this->required === true
			&& $this->nullable !== true) {
			throw new AssertionException(sprintf('The variable "%s" is required, null given.', $this->getName()));
		}
